...
{
    public const DEF_HOUR = 0;
    public const DEF_MIN = 30;
    ...
    {
        return [
            [['archive_id', 'teacher_id', 'student_id', 'begin_date', 'end_date'], 'required'],
            [['archive_id', 'teacher_id', 'student_id', 'begin_date', 'end_date'], 'integer'],
