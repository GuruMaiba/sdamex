...
return [
    ...
    'subInx' => 1,                              // Индекс активного предмета
    ...
    'listSubs' => [     // Список предметов
        ...
        6 => [
            ...
            'link' => (YII_ENV_DEV) ? 'http://sub.sdamex.loc/' : 'https://scl.sdamex.ru/',
            'isActive' => false,
        ], // Обществознание
        7 => [
            'name' => 'PHYSICS',
        ...
        //     'name' => 'DEUTSCH',
        //     'lable' => 'Немецкий',
        //     'link' => (YII_ENV_DEV) ? 'http://sub.sdamex.loc/' : 'https://dtc.sdamex.ru/',
        //     'isActive' => false,
        // ], // Немецкий
        // 14 => [
        //     'name' => 'SPANISH',
        //     'lable' => 'Испанский',
        //     'link' => (YII_ENV_DEV) ? 'http://sub.sdamex.loc/' : 'https://spn.sdamex.ru/',
        //     'isActive' => false,
        // ], // Испанский
        // 15 => [
        //     'name' => 'FRENCH',
        //     'lable' => 'Французкий',
        //     'link' => (YII_ENV_DEV) ? 'http://sub.sdamex.loc/' : 'https://frn.sdamex.ru/',
        //     'isActive' => false,
        // ], // Французкий
    ],
